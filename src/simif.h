...
#ifndef SIMIF_H_1302537924
#define SIMIF_H_1302537924
 ...
 */
class SimIf: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    SimIf(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
